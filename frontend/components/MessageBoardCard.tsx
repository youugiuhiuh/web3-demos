...
export default function MessageBoardCard() {
	...
	return (
		<motion.div
			...
			className="w-full max-w-2xl bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden"
		>
			...
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
				<div className="flex flex-col">
					<h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-purple-600 dark:from-cyan-400 dark:to-purple-400">
						Message Board
					</h2>
			...
			<div className="space-y-3 mb-10">
				<h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">
					Latest Broadcast
				</h3>
				<motion.div
					layout
					className="relative px-8 py-10 bg-slate-100/50 dark:bg-black/40 rounded-2xl border border-slate-200 dark:border-white/5 shadow-inner min-h-[160px] flex items-center justify-center text-center group"
				>
					<AnimatePresence mode="wait">
						{currentMessage ? (
							<motion.p
								...
								exit={{ opacity: 0, y: -10 }}
								className="text-3xl sm:text-4xl font-semibold text-slate-800 dark:text-slate-100 leading-tight"
							>
			...
			<div className="space-y-4">
				<div className="relative">
					<textarea
						...
						rows={3}
						className="w-full px-6 py-5 bg-white/50 dark:bg-black/40 border border-slate-200 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-600 transition-all resize-none shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
					/>
